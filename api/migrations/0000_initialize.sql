...
CREATE TABLE IF NOT EXISTS TeamMatchEntry(
  ...
  autoCoralAL1 integer, autoCoralAL2 boolean, autoCoralAL3 boolean, autoCoralAL4 boolean,
  autoCoralBL1 integer, autoCoralBL2 boolean, autoCoralBL3 boolean, autoCoralBL4 boolean,
  autoCoralCL1 integer, autoCoralCL2 boolean, autoCoralCL3 boolean, autoCoralCL4 boolean,
  autoCoralDL1 integer, autoCoralDL2 boolean, autoCoralDL3 boolean, autoCoralDL4 boolean,
  autoCoralEL1 integer, autoCoralEL2 boolean, autoCoralEL3 boolean, autoCoralEL4 boolean,
  autoCoralFL1 integer, autoCoralFL2 boolean, autoCoralFL3 boolean, autoCoralFL4 boolean,
  autoCoralGL1 integer, autoCoralGL2 boolean, autoCoralGL3 boolean, autoCoralGL4 boolean,
  autoCoralHL1 integer, autoCoralHL2 boolean, autoCoralHL3 boolean, autoCoralHL4 boolean,
  autoCoralIL1 integer, autoCoralIL2 boolean, autoCoralIL3 boolean, autoCoralIL4 boolean,
  autoCoralJL1 integer, autoCoralJL2 boolean, autoCoralJL3 boolean, autoCoralJL4 boolean,
  autoCoralKL1 integer, autoCoralKL2 boolean, autoCoralKL3 boolean, autoCoralKL4 boolean,
  autoCoralLL1 integer, autoCoralLL2 boolean, autoCoralLL3 boolean, autoCoralLL4 boolean,
